...
wait
python3 frame.py test_train_partitions/str_partition/str_all/ test_train_partitions/ptosis_partition/ptosis_all/ 3 --hog --all & #>> ./output/reports/str_ptosis.txt  &
...
python3 frame.py test_train_partitions/osd_partition/osd_all/ test_train_partitions/str_partition/str_all/ 3 --hog --all & #>> ./output/reports/osd_str.txt &
